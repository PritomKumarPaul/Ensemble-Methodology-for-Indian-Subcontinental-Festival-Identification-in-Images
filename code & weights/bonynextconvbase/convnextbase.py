...
model.save_weights('F:/AUST/4.2/8. CSE4238 - Soft Computing Lab/Project/convnextbase.h5', overwrite=True, save_format=None, options=None)
...
model.load_weights('F:/AUST/4.2/8. CSE4238 - Soft Computing Lab/Project/convnextbase.h5', skip_mismatch=False, by_name=False, options=None)
