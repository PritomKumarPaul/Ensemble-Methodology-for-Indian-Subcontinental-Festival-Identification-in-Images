# -*- coding: utf-8 -*-
"""
Created on Fri Jan  5 22:21:02 2024
...
checkpoint_filepath = 'D:/4.2/sc lab/ckpt.h5'
...
model.save_weights('F:/soft-computing-project-master/mobilenet.h5', overwrite=True, save_format=None, options=None)
...
model.load_weights('F:/soft-computing-project-master/ckpt.h5', skip_mismatch=False, by_name=False, options=None)

model.load_weights('F:/soft-computing-project-master/mobilenet.h5', skip_mismatch=False, by_name=False, options=None)
